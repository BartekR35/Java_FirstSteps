...
public class TaxCounting {
    public static void main(String[] args) {
        ...
        /* double P1NetCostRainka = 9.99;
        double P1GrossCostRainka = P1NetCostRainka * 1.23;

        P1GrossCostRainka = P1GrossCostRainka * 10000;

        P1NetCostRainka = P1GrossCostRainka * 0.77;

        System.out.println(P1NetCostRainka);
